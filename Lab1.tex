...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.3\textwidth}
      ...
      \caption{WhatsApp Fraud: Mimics of Punjab}
      \label{fig:sub1}
    \end{subfigure}%
    \begin{subfigure}{.3\textwidth}
      \centering
    ...
    \begin{subfigure}{.3\textwidth}
      ...
      \caption{Financial Deception: Synthetic Remittance}
      \label{fig:sub3}
    \end{subfigure}
...
\textit{WhatsApp Fraud: Mimics of Punjab} & A case of social engineering where victims are deceived into financial loss through WhatsApp communications. & Trust exploitation, lack of digital literacy & Impersonation, phishing messages \\
